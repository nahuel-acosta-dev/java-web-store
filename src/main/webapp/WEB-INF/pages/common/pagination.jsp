    ...
    <ul class="pagination">
        <c:if test="${sessionScope['currentPage'] > 1}">
            <li class="page-item">
                <a 
                    class="page-link" 
                    href="${pageContext.request.contextPath}/ProductsServletController?pagination=${
        ...
        <c:if test="${sessionScope['currentPage'] > 10}">
            <li class="page-item">
                <a class="page-link" 
                href="${
                pageContext.request.contextPath}/ProductsServletController?pagination=${1}">
                   <c:out value = "..."/>
                </a>
            </li>   
        </c:if>  
            ...
            <c:choose>
                <c:when test="${sessionScope['currentPage'] == i}">
                        <li class="page-item active">
                            <a class="page-link" 
                            href="${
                            pageContext.request.contextPath}/ProductsServletController?pagination=${i}">
                                 <c:out value = "${i}"/>
                            </a>
                        </li>     
                </c:when>
        ...
        <c:if test="${sessionScope['sessionProducts'].getSections() > 10 && 
            ...
            <li class="page-item">
                <a class="page-link" 
                href="${
                pageContext.request.contextPath}/ProductsServletController?pagination=${
